...
(function (root, factory) {
    ...
    joint.dia.Graph = Backbone.Model.extend({
        ...
        bfs: function (element, iteratee, opt) {
            ...
            while (queue.length > 0) {
                ...
                if (!visited[next.id]) {
                    ...
                    if (iteratee(next, distance[next.id]) === false)
                        return;
        ...
        dfs: function (element, iteratee, opt, _visited, _distance) {
            ...
            if (iteratee(element, distance) === false)
                return;
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        getPathData: function (vertices) {
            ...
            var pathData = connectorFn.call(this, this._markerCache.sourcePoint, // Note that the value is translated by the size
            this._markerCache.targetPoint, // of the marker. (We'r not using this.sourcePoint)
            vertices || (this.model.get('vertices') || {}), args, // options
            this);
            return pathData;
        },
        ...
        pointerdown: function (evt, x, y) {
            ...
            if (evt.target.getAttribute('magnet') != null)
                return;
            var interactive = _.isFunction(this.options.interactive) ? this.options.interactive(this, 'pointerdown') : this.options.interactive;
            if (interactive === false)
                return;
            ...
            if (this._action === 'label-move') {
                ...
                if (paperOptions.snapLinks) {
                    ...
                    if (magnetUnderPointer) {
                        ...
                        if (selector != null)
                            arrowheadValue.port = port;
                        if (port != null)
                            arrowheadValue.selector = selector;
    ...
    joint.connectors.jumpover = (function (_, g) {
         ...
         */
        return function (sourcePoint, targetPoint, vertices, opts) {
            setupUpdating(this);
            ...
            if (allLinks.length === 1) {
                return buildPath(createLines(sourcePoint, targetPoint, vertices), jumpSize, jumpType);
            }
            ...
            var thisLines = createLines(sourcePoint, targetPoint, vertices);
    ...
    joint.layout.DirectedGraph = {
        layout: function (graph, opt) {
            ...
            if (opt.marginX)
                glLabel.marginx = opt.marginX;
            if (opt.marginY)
                glLabel.marginy = opt.marginY;
